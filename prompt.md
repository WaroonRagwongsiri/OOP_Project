...
Call subscribe with customer_id={customer_id}, payment_gateway_name="Card", payment_information="4111111111111111" → save member_id_2
Call unsubscribe with member_id={member_id_2} → expect success message
...
Re-add product and mark is_buy=true
Call purchase with customer_id={customer_id}, payment_method_name="Card", payment_information=["4111111111111111"], coupon_id=null → save bill_id_2 and product_serials_2
💸 Phase 6c – Refund
...
Call refund with customer_id={customer_id}, bill_id={bill_id_2}, product_serial_numbers={product_serials_2} → expect refund coupon returned
